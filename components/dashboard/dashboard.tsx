  ...
  return (
    <div className="px-8 py-12">
      <div className="mb-16 animate-fade-in-up">
        ...
        <p className="text-[14px] text-[#aaaaaa]">28 violations found • Last scanned 2 minutes ago</p>
      </div>
      ...
      <div className="grid grid-cols-[1.5fr,1fr] gap-16">
        ...
        <div className="animate-fade-in-left delay-200">
          <h2 className="text-[13px] uppercase tracking-wider text-[#aaaaaa] mb-6">Violations by Severity</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-baseline justify-between py-3 border-b border-[#1a1a1a]">
              ...
              <span className="text-[32px] font-bold text-[#aaaaaa] tabular-nums">{violations.low}</span>
            </div>
          </div>
        ...
        <div className="animate-fade-in-right delay-300">
          <h2 className="text-[13px] uppercase tracking-wider text-[#aaaaaa] mb-6">Recent Activity</h2>
          ...
          <div className="space-y-4">
            {recentActivity.map((activity) => (
              <div key={`${activity.type}-${activity.time}`} className="border-b border-[#0a0a0a] pb-4">
                ...
                <p className="text-[11px] text-[#aaaaaa]">{activity.time}</p>
              </div>
            ))}
          </div>
        </div>
