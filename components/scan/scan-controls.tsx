    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {Object.entries(selectedControls).map(([control, checked]) => (
        <button
          ...
          className={`group relative inline-flex items-center gap-2 rounded-xl px-3 py-2 text-left text-xs font-semibold transition-all duration-150 ease-out hover:scale-[1.02] active:scale-[0.98] border ${
            checked
